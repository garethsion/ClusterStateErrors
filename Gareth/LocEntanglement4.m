function loc4 = LocEntanglement4(rho,m,n)
    ...
    rho_reduced_x00 = (1/Ps_x00) * PartialTrace((Px_00)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_x01 = (1/Ps_x01) * PartialTrace((Px_01)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_x10 = (1/Ps_x10) * PartialTrace((Px_10)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_x11 = (1/Ps_x11) * PartialTrace((Px_11)*rho,[m2,n2],[2,2,2,2]);
    
    rho_reduced_y00 = (1/Ps_y00) * PartialTrace((Py_00)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_y01 = (1/Ps_y01) * PartialTrace((Py_01)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_y10 = (1/Ps_y01) * PartialTrace((Py_10)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_y11 = (1/Ps_y11) * PartialTrace((Py_11)*rho,[m2,n2],[2,2,2,2]);
    
    rho_reduced_z00 = (1/Ps_z00) * PartialTrace((Pz_00)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_z01 = (1/Ps_z01) * PartialTrace((Pz_01)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_z10 = (1/Ps_z10) * PartialTrace((Pz_10)*rho,[m2,n2],[2,2,2,2]);
    rho_reduced_z11 = (1/Ps_z11) * PartialTrace((Pz_11)*rho,[m2,n2],[2,2,2,2]);
