...
figure;bar3(real(rho_cycle1));hold on; bar3(imag(rho_cycle1));
...
figure;bar3(real(rho_cycle2)); hold on; bar3(imag(rho_cycle2))
...
figure;bar3(real(rho_cycle3)); hold on; bar3(imag(rho_cycle3));
...
figure;bar3(real(rho_cycle4));hold on; bar3(imag(rho_cycle4));
